...
public class KafkaWriterITCase {
    ...
    private MockMetricGroup metricGroup;
    ...
    @Before
    public void setUp() {
        metricGroup = new MockMetricGroup();
    }
    ...
    public void testRegisterMetrics() throws Exception {
        try (final KafkaWriter<Integer> ignored =
                new KafkaWriter<>(
                        ...
                        "test-prefix",
                        new SinkInitContext(metricGroup),
                        new DummyRecordSerializer(),
                        new DummySchemaContext(),
                        ImmutableList.of())) {
            assertThat(metricGroup.addedGroups, contains("KafkaProducer"));
            assertFalse(metricGroup.registeredGauges.isEmpty());
        }
    }
    ...
    public void testNotRegisterMetrics() throws Exception {
        ...
        try (final KafkaWriter<Integer> ignored =
                new KafkaWriter<>(
                        ...
                        new DummySchemaContext(),
                        ImmutableList.of())) {
            assertTrue(metricGroup.addedGroups.isEmpty());
            assertTrue(metricGroup.registeredGauges.isEmpty());
        }
    }
    ...
    private static class MockMetricGroup implements MetricGroup {

        private Set<String> addedGroups = new HashSet<>();
        private Set<String> registeredGauges = new HashSet<>();
